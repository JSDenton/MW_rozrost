...
class Ui_MainWindow(object):
    ...
    def init_thread(self):
        ...
        self.worker_thread.started.connect(self.space.run)
        self.space.finished.connect(self.worker_thread.quit)
        
        #self.space.finished.connect(self.space.deleteLater)
        self.space.finished.connect(self.stop_simulation)
        #self.worker_thread.finished.connect(self.worker_thread.deleteLater)

        self.space.refresh_func.connect(self.refresh_canvas)
    ...
    def generate_space(self):
        ...
        self.space.generate_space(self.spinBox_nucleon_count.value(), self.comboBox_distribution.currentText(), self.get_points)
    ...
    def start_simulation(self):
        ...
        self.space.send_args(type=self.comboBox_neighourhood.currentText(), boundaries_type=self.comboBox_boundaries.currentText(), refresh = self.refresh_canvas)
        ...
        self.pushButton_start.clicked.disconnect(self.start_simulation)
        
    
    #def run(self):
    #    print("running...")
    #    self.space.main_loop()
    #    print("finished...")
    ...
    def stop_simulation(self):
        ...
        self.pushButton_start.clicked.disconnect(self.stop_simulation)
        self.pushButton_start.clicked.connect(self.start_simulation)
        self.pushButton_start.setText(_translate("MainWindow", "Start simulation"))       
